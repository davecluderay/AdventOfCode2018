...
internal static class Operations
{
    public static void Addr(Instruction instruction, int[] registers)
        => registers[instruction.C] = unchecked(registers[instruction.A] + registers[instruction.B]);

    public static void Addi(Instruction instruction, int[] registers)
        => registers[instruction.C] = unchecked(registers[instruction.A] + instruction.B);
